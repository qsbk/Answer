...
namespace  Answerquestions{
    internal class MySQLDatabase {
        ...
        private static string host = "rm-bp1uqois4fxz484n70o.mysql.rds.aliyuncs.com";     //IP地址。如果只是在本地的话，写localhost就可以。
        private static string id = "answer";       //用户名。
        private static string pwd = "kA%S!*gz36$Xaz_";      //密码。
        private static string dataBase = "answer"; //数据库名称。
        ...
        public MySQLDatabase(string _host, string _id, string _pwd, string _dataBase) {
            host = _host;
            id = _id;
            pwd = _pwd;
            dataBase = _dataBase;
